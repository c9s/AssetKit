...
class AssetWriter
{
    ...
    public function init()
    {
        $this->addCompressor('jsmin', function() {
            return new \AssetToolkit\Compressor\JsMinCompressor;
        });

        $this->addCompressor('cssmin', function() {
            return new \AssetToolkit\Compressor\CssMinCompressor;
        });
        ...
        $this->addFilter( 'coffeescript' ,function() {
            return new \AssetToolkit\Filter\CoffeeScriptFilter;
        });

        $this->addFilter( 'css_import', function() {
            return new \AssetToolkit\Filter\CssImportFilter;
        });

        $this->addFilter( 'sass' , function() {
            return new \AssetToolkit\Filter\SassFilter;
        });

        $this->addFilter( 'scss' , function() {
            return new \AssetToolkit\Filter\ScssFilter;
        });

        $this->addFilter( 'css_rewrite', function() {
            return new \AssetToolkit\Filter\CssRewriteFilter;
        });
